...
export interface SwapHelperUpgradeableInterface extends Interface {
  getFunction(nameOrSignature: "dexRouter" | "getSwapQuote"): FunctionFragment;

  getEvent(
    nameOrSignatureOrTopic: "DEXRouterUpdated" | "Initialized" | "SwapExecuted"
  ): EventFragment;
...
export interface SwapHelperUpgradeable extends BaseContract {
  connect(runner?: ContractRunner | null): SwapHelperUpgradeable;
  waitForDeployment(): Promise<this>;

  interface: SwapHelperUpgradeableInterface;
