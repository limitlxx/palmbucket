...
export interface BucketVaultUpgradeableInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface BucketVaultUpgradeable extends BaseContract {
  connect(runner?: ContractRunner | null): BucketVaultUpgradeable;
  waitForDeployment(): Promise<this>;

  interface: BucketVaultUpgradeableInterface;
