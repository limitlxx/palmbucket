...
export interface SpendableVaultInterface extends Interface {
  getFunction(
    nameOrSignature:
  ...
  encodeFunctionData(
    functionFragment: "previewInstantWithdraw",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
...
export interface SpendableVault extends BaseContract {
  connect(runner?: ContractRunner | null): SpendableVault;
  waitForDeployment(): Promise<this>;

  interface: SpendableVaultInterface;
  ...
  fastTransfer: TypedContractMethod<
  ...
  previewInstantWithdraw: TypedContractMethod<
    [assets: BigNumberish],
    [bigint],
    "view"
  >;
  ...
  getFunction(
    nameOrSignature: "previewInstantWithdraw"
  ): TypedContractMethod<[assets: BigNumberish], [bigint], "view">;
  getFunction(
