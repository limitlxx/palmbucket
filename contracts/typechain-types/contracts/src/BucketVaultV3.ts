...
export interface BucketVaultV3Interface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface BucketVaultV3 extends BaseContract {
  connect(runner?: ContractRunner | null): BucketVaultV3;
  waitForDeployment(): Promise<this>;

  interface: BucketVaultV3Interface;
