...
export interface BucketVaultV2Interface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface BucketVaultV2 extends BaseContract {
  connect(runner?: ContractRunner | null): BucketVaultV2;
  waitForDeployment(): Promise<this>;

  interface: BucketVaultV2Interface;
